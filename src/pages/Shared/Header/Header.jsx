            ...
            <div className="max-w-[1280px] mx-auto">
                <div className="navbar">
                    <div className="navbar-start">
                        ...
                        <a className="btn btn-ghost italic text-xl text-white">Fashion and Apparel BY Rima</a>
                    </div>
                    ...
                    <div className="navbar-end">
                        ...
                        <Link to="/registration"><button className="btn ml-2">Registration</button></Link>
                    </div>
                </div>
            </div>
        </header>
